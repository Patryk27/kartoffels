...
//! Dijkstra algorithm.
//!
//! Overall, this algorithm causes the robot to search the entire maze, taking
...
fn scan(map: &mut Map, pos: I8Vec2, dir: Dir) -> bool {
    ...
    serial_write(format!("{discovered} "));
...
fn drive(pos: &mut I8Vec2, dir: &mut Dir, target: I8Vec2) {
    ...
    // direction (as required by us to actually move the robot).
    //
